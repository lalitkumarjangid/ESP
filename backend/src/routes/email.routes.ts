...
export const RouteDescriptions = {
  [EmailRoutes.GENERATE]:
    'Generate unique test email address and subject line for sending test emails',
  [EmailRoutes.RESULTS]:
    'Get processed email data including receiving chain and ESP type by email ID',
  [EmailRoutes.ALL_EMAILS]: 'Get all processed emails for dashboard display',
  [EmailRoutes.DASHBOARD]:
    'Get dashboard summary with analytics and recent emails',
};
